    ...
    <main className="min-h-screen px-6 py-10 max-w-6xl mx-auto">
      <header className="mb-10">
        ...
        <p className="text-neutral-400 mt-2 text-sm leading-relaxed">
          Upload a JPEG. Gemini analyzes the image and generates a Lightroom Classic <code className="text-neutral-300">.xmp</code> preset
      ...
      <footer className="mt-16 text-xs text-neutral-600 text-center">
        Built with Gemini 2.0 Flash vision · Schema-validated output
      </footer>
    </main>
  );
}
